...
const NearByStackNavigator = () => {
  return (
    <NearByStack.Navigator>
      ...
      <NearByStack.Screen name="UserProfile" component={UserProfile} />
    </NearByStack.Navigator>
  );
};
...
const DrawerNavigator = () => {
  return (
    <Drawer.Navigator drawerContent={(props) => <Sidebar {...props} />}>
      ...
      <Drawer.Screen
        name="PrivateAccount"
        component={PrivateAccountNavigator}
        options={{
